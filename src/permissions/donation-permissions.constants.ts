...
const ALLOTMENTS = "fund_raising.donation_allotments";

export const DONATION_ALLOTMENT_VIEW_PERMISSIONS = [
  `${ALLOTMENTS}.view`,
] as const;

export const DONATION_ALLOTMENT_LIST_VIEW_PERMISSIONS = [
  `${ALLOTMENTS}.list_view`,
] as const;

export const DONATION_ALLOTMENT_CREATE_PERMISSIONS = [
  `${ALLOTMENTS}.create`,
] as const;

export const DONATION_ALLOTMENT_APPROVE_PERMISSIONS = [
  `${ALLOTMENTS}.approve`,
] as const;

export const DONATION_ALLOTMENT_VIEW_GUARD = [
  ...DONATION_ALLOTMENT_VIEW_PERMISSIONS,
  "super_admin",
  "fund_raising_manager",
] as const;

export const DONATION_ALLOTMENT_LIST_VIEW_GUARD = [
  ...DONATION_ALLOTMENT_LIST_VIEW_PERMISSIONS,
  "super_admin",
  "fund_raising_manager",
] as const;

export const DONATION_ALLOTMENT_CREATE_GUARD = [
  ...DONATION_ALLOTMENT_CREATE_PERMISSIONS,
  "super_admin",
  "fund_raising_manager",
] as const;

export const DONATION_ALLOTMENT_APPROVE_GUARD = [
