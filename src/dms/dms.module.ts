...
@Module({
  ...
  imports: [
    ...
    PermissionsModule,
    DonorModule, UserDonorsModule, DonationBoxModule, DonationInKindModule, BlinqModule, PayfastModule, MeezanModule, GeographicModule, RecurringDonationsModule, SurveysModule, EventsModule, CampaignsModule, EmailTemplateModule ],        
})
