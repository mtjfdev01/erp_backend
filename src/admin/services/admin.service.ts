    ...
    try {
      ...
      const [accountsAndFinance, procurements, store, applicationReports, areaRationReports, educationReports] = await Promise.all([
        ...
        this.applicationReportRepository
          ...
          .addSelect('COUNT(*)', 'Total Reports') // ✅ use COUNT(*)
          .addSelect('SUM(a_r_report.pending_last_month + a_r_report.application_count + a_r_report.investigation_count + a_r_report.approved_count + a_r_report.rejected_count + a_r_report.pending_count)', 'Grand_Total')
