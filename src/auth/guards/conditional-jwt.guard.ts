...
export class ConditionalJwtGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (request.headers.origin === 'http://localhost:3001' || request.headers.origin === 'https://donation.mtjfoundation.org' || request.headers.origin === 'https://mtjf-site.vercel.app') {
