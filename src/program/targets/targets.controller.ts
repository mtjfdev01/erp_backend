...
export class TargetsController {
  ...
  @Get()
  @RequiredPermissions(['program.targets.list_view', 'program.targets.view', 'super_admin', 'programs_manager', 'read_only_super_admin'])
  findAll(
    ...
    return this.targetsService.findAll(pageNum, pageSizeNum, sortField, sortOrder);
  }

  @Get(':id')
  @RequiredPermissions(['program.targets.view', 'super_admin', 'programs_manager', 'read_only_super_admin'])
