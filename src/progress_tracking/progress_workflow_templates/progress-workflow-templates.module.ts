...
@Module({
  imports: [
    TypeOrmModule.forFeature([ProgressWorkflowTemplate, ProgressWorkflowTemplateStep]),
    JwtModule.register({
...
export class ProgressWorkflowTemplatesModule implements OnModuleInit {
  constructor(private readonly templatesService: ProgressWorkflowTemplatesService) {}
