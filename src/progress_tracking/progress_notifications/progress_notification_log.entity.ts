...
export class ProgressNotificationLog extends BaseEntity {
  @ManyToOne(() => ProgressTracker, (tracker) => tracker.notification_logs, { nullable: true, onDelete: 'SET NULL' })
  ...
  @ManyToOne(() => ProgressTrackerStep, { nullable: true, onDelete: 'SET NULL' })
